...
public class ContentBrowserPanel {
    ...
    public ContentBrowserPanel() {
        ...
        directoryIconTexture = TextureLibrary.uploadTexture(Path.of("SuperNova/src/main/resources/icons/directory.png"));
        documentIconTexture = TextureLibrary.uploadTexture(Path.of("SuperNova/src/main/resources/icons/document.png"));
        returnIconTexture = TextureLibrary.uploadTexture(Path.of("SuperNova/src/main/resources/icons/back-arrow.png"));
    }
            ...
            for (var file : files) {
                if (file.isDirectory()) {
                    ...
                    if (file.getName().endsWith(".png") || file.getName().endsWith(".jpg")) {
                        var texture = TextureLibrary.uploadTexture(file.toPath());
