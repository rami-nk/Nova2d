...
public class ImGuiImplGlfw {
    ...
    public void mouseButtonCallback(final long windowId, final int button, final int action, final int mods) {
        if (prevUserCallbackMouseButton != null && windowId == glfwWindow) {
    ...
    public void scrollCallback(final long windowId, final double xOffset, final double yOffset) {
        if (prevUserCallbackScroll != null && windowId == glfwWindow) {
    ...
    public void keyCallback(final long windowId, final int key, final int scancode, final int action, final int mods) {
        if (prevUserCallbackKey != null && windowId == glfwWindow) {
    ...
    public void windowFocusCallback(final long windowId, final boolean focused) {
        if (prevUserCallbackWindowFocus != null && windowId == glfwWindow) {
    ...
    public void cursorEnterCallback(final long windowId, final boolean entered) {
        if (prevUserCallbackCursorEnter != null && windowId == glfwWindow) {
    ...
    public void charCallback(final long windowId, final int c) {
        if (prevUserCallbackChar != null && windowId == glfwWindow) {
    ...
    public boolean init(final long windowId, final boolean installCallbacks) {
        ...
        mainViewport.setPlatformHandle(glfwWindow);
    ...
    public void dispose() {
        ...
        try {
            if (callbacksInstalled) {
                glfwSetWindowFocusCallback(glfwWindow, prevUserCallbackWindowFocus).free();
                glfwSetCursorEnterCallback(glfwWindow, prevUserCallbackCursorEnter).free();
                glfwSetMouseButtonCallback(glfwWindow, prevUserCallbackMouseButton).free();
                glfwSetScrollCallback(glfwWindow, prevUserCallbackScroll).free();
                glfwSetKeyCallback(glfwWindow, prevUserCallbackKey).free();
                glfwSetCharCallback(glfwWindow, prevUserCallbackChar).free();
    ...
    private void updateMousePosAndButtons() {
        ...
        for (int i = 0; i < ImGuiMouseButton.COUNT; i++) {
            ...
            io.setMouseDown(i, mouseJustPressed[i] || glfwGetMouseButton(glfwWindow, i) != 0);
    ...
    private void updateMouseCursor() {
        ...
        final boolean cursorDisabled = glfwGetInputMode(glfwWindow, GLFW_CURSOR) == GLFW_CURSOR_DISABLED;
    ...
    private final class CreateWindowFunction extends ImPlatformFuncViewport {
        ...
        public void accept(final ImGuiViewport vp) {
            ...
            data.window = glfwCreateWindow((int) vp.getSizeX(), (int) vp.getSizeY(), "No Title Yet", NULL, glfwWindow);
